  ...
  return (
    <div ref={containerRef} className="h-[300vh] ">
      <div className="sticky top-0 h-screen flex items-center justify-center overflow-hidden bg-gray-100">
        {/* Left Curtain */}
        <motion.div
          className="absolute left-0 top-0 bottom-0 w-1/2 bg-cover bg-center"
          style={{
            backgroundImage: "url('/cur.png')",
            x: curtainLeftX,
            scale: curtainScale,
...
export default InteractiveShopEntrance;
